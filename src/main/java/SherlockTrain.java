...
public class SherlockTrain extends SherlockBase {
    public SherlockTrain(String ip, String port, String bucket_name, String model_pref, String model_name) throws IOException, ApiException {
        super(ip, port, bucket_name, model_pref, model_name);
    }

    public void train(String url, String bucket) throws IOException {
        String json = "";
        try {
